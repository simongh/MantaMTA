...
namespace OpenManta.Framework.Smtp
{
    ...
    /// </summary>
    internal class MantaOutboundClient : IDisposable
    {
        ...
        private TcpClient CreateTcpClient()
        {
            ...
            tcp.ReceiveTimeout = MtaParameters.Client.ConnectionReceiveTimeoutInterval * 1000;
            tcp.SendTimeout = MtaParameters.Client.ConnectionSendTimeoutInterval * 1000;
        ...
        /// </summary>
        private VirtualMTA _VirtualMta { get; set; }
