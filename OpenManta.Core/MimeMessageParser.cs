...
{
	public static class MimeMessageParserFactory
	{
		public static IMimeMessageParser Instance { get; internal set; }
	}

	internal class MimeMessageParser : IMimeMessageParser
	{
		/// <summary>
		...
		private BodyPart[] DivideIntoBodyParts(string content, string boundary)
		{
		...
		private BodyPart CreateBodyPart(string content)
		{
			string headersChunk;
			string bodyChunk;
		...
		private BodyPart CreateBodyPart(MessageHeaderCollection headers, string bodyChunk)
		{
		...
		private TransferEncoding IdentifyTransferEncoding(string transferEncoding)
		{
		...
		private void SeparateBodyPartHeadersAndBody(string content, out string headers, out string body)
		{
		...
		private string RemoveFunctionalBlankLinesAroundContent(string content)
		{
			string temp = content;
		...
		private MessageHeaderCollection GetMessageHeaders(string headersChunk)
		{
		...
		public string UnfoldHeaders(string headersBlock)
		{
